...
## Contents
 - A bridge bewteen Openfin and kdb+
   - files [kof.js](kof.js)
 ...
 - Simple HTML5 canvas heat map demo with kdb+
   - files [hm.htm](hm.htm), [hm.js](hm.js), [hm.q](hm.q)
   - hosted locally using kdb+ server for http and Websocket
 - An example Openfin [index.htm](index.htm), [app.json](app.json) - an Openfin headless app that opens [hm.htm](hm.htm)
